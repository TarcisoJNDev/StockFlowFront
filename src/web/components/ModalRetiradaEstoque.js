// src/web/components/ModalRetiradaEstoque.js
...
const ModalRetiradaEstoque = ({ visible, produto, onClose, onSalvar }) => {
                ...
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        ...
                        <View style={styles.modalHeader}>
                            <Text style={styles.modalTitle}>📤 Retirada do Estoque</Text>
                        ...
                        <ScrollView style={styles.form}>
                            ...
                            <View style={styles.inputGroup}>
                                ...
                                <TextInput
                                    ...
                                    placeholder="Motivo da retirada, cliente, etc."
                                    value={observacao}
                        ...
                        <View style={styles.modalFooter}>
                            ...
                            >
                                <Text style={styles.textoBotaoSalvar}>Confirmar Retirada</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
...
export default ModalRetiradaEstoque;